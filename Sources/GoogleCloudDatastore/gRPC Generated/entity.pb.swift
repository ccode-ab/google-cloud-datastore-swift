...
struct Google_Datastore_V1_Key {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  var path: [Google_Datastore_V1_Key.PathElement] = []
  ...
  struct PathElement {
    ...
    /// The type of ID.
    var idType: Google_Datastore_V1_Key.PathElement.OneOf_IDType? = nil
    ...
    #if !swift(>=4.1)
      static func ==(lhs: Google_Datastore_V1_Key.PathElement.OneOf_IDType, rhs: Google_Datastore_V1_Key.PathElement.OneOf_IDType) -> Bool {
        switch (lhs, rhs) {
...
/// An array value.
struct Google_Datastore_V1_ArrayValue {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// metadata.
struct Google_Datastore_V1_Value {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// Must have a value set.
  var valueType: Google_Datastore_V1_Value.OneOf_ValueType? = nil
  ...
  /// A key value.
  var keyValue: Google_Datastore_V1_Key {
    get {
  ...
  var geoPointValue: Google_Type_LatLng {
    get {
  ...
  var entityValue: Google_Datastore_V1_Entity {
    get {
  ...
  var arrayValue: Google_Datastore_V1_ArrayValue {
    get {
  ...
  /// explicitly.
  var excludeFromIndexes: Bool = false
  ...
  #if !swift(>=4.1)
    static func ==(lhs: Google_Datastore_V1_Value.OneOf_ValueType, rhs: Google_Datastore_V1_Value.OneOf_ValueType) -> Bool {
      switch (lhs, rhs) {
      case (.nullValue(let l), .nullValue(let r)): return l == r
      case (.booleanValue(let l), .booleanValue(let r)): return l == r
      case (.integerValue(let l), .integerValue(let r)): return l == r
      case (.doubleValue(let l), .doubleValue(let r)): return l == r
      case (.timestampValue(let l), .timestampValue(let r)): return l == r
      case (.keyValue(let l), .keyValue(let r)): return l == r
      case (.stringValue(let l), .stringValue(let r)): return l == r
      case (.blobValue(let l), .blobValue(let r)): return l == r
      case (.geoPointValue(let l), .geoPointValue(let r)): return l == r
      case (.entityValue(let l), .entityValue(let r)): return l == r
...
/// message.
struct Google_Datastore_V1_Entity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// The name cannot be `""`.
  var properties: Dictionary<String,Google_Datastore_V1_Value> = [:]
...
extension Google_Datastore_V1_PartitionId: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".PartitionId"
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularStringField(value: &self.namespaceID)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Google_Datastore_V1_PartitionId, rhs: Google_Datastore_V1_PartitionId) -> Bool {
...
extension Google_Datastore_V1_Key: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._partitionID)
  ...
  static func ==(lhs: Google_Datastore_V1_Key, rhs: Google_Datastore_V1_Key) -> Bool {
...
extension Google_Datastore_V1_Key.PathElement: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Google_Datastore_V1_Key.protoMessageName + ".PathElement"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "kind"),
    2: .same(proto: "id"),
    3: .same(proto: "name"),
  ...
  static func ==(lhs: Google_Datastore_V1_Key.PathElement, rhs: Google_Datastore_V1_Key.PathElement) -> Bool {
...
extension Google_Datastore_V1_ArrayValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Google_Datastore_V1_ArrayValue, rhs: Google_Datastore_V1_ArrayValue) -> Bool {
...
extension Google_Datastore_V1_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1:
        ...
        if let v = v {self.valueType = .booleanValue(v)}
      case 2:
        if self.valueType != nil {try decoder.handleConflictingOneOf()}
        var v: Int64?
        try decoder.decodeSingularInt64Field(value: &v)
        if let v = v {self.valueType = .integerValue(v)}
      case 3:
        if self.valueType != nil {try decoder.handleConflictingOneOf()}
        var v: Double?
        try decoder.decodeSingularDoubleField(value: &v)
        if let v = v {self.valueType = .doubleValue(v)}
      case 5:
        ...
        if let v = v {self.valueType = .keyValue(v)}
      case 6:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.valueType = .entityValue(v)}
      case 8:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.valueType = .geoPointValue(v)}
      case 9:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.valueType = .arrayValue(v)}
      case 10:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.valueType = .timestampValue(v)}
      case 11:
        if self.valueType != nil {try decoder.handleConflictingOneOf()}
        var v: SwiftProtobuf.Google_Protobuf_NullValue?
        try decoder.decodeSingularEnumField(value: &v)
        if let v = v {self.valueType = .nullValue(v)}
      case 14: try decoder.decodeSingularInt32Field(value: &self.meaning)
      case 17:
        if self.valueType != nil {try decoder.handleConflictingOneOf()}
        var v: String?
        try decoder.decodeSingularStringField(value: &v)
        if let v = v {self.valueType = .stringValue(v)}
      case 18:
        if self.valueType != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.valueType = .blobValue(v)}
      case 19: try decoder.decodeSingularBoolField(value: &self.excludeFromIndexes)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Google_Datastore_V1_Value, rhs: Google_Datastore_V1_Value) -> Bool {
...
extension Google_Datastore_V1_Entity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Datastore_V1_Value>.self, value: &self.properties)
      default: break
      }
    }
  }
  ...
  static func ==(lhs: Google_Datastore_V1_Entity, rhs: Google_Datastore_V1_Entity) -> Bool {
