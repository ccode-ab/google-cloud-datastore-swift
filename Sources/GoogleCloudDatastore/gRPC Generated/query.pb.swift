...
struct Google_Datastore_V1_Query {
  ...
  var startCursor: Data = SwiftProtobuf.Internal.emptyData

  /// An ending point for the query results. Query cursors are
  /// returned in query result batches and
  /// [can only be used to limit the same
  /// query](https://cloud.google.com/datastore/docs/concepts/queries#cursors_limits_and_offsets).
  var endCursor: Data = SwiftProtobuf.Internal.emptyData
...
struct Google_Datastore_V1_Filter {
  ...
  enum OneOf_FilterType: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_Filter.OneOf_FilterType, rhs: Google_Datastore_V1_Filter.OneOf_FilterType) -> Bool {
      switch (lhs, rhs) {
      case (.compositeFilter(let l), .compositeFilter(let r)): return l == r
      case (.propertyFilter(let l), .propertyFilter(let r)): return l == r
...
struct Google_Datastore_V1_GqlQueryParameter {
  ...
  enum OneOf_ParameterType: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_GqlQueryParameter.OneOf_ParameterType, rhs: Google_Datastore_V1_GqlQueryParameter.OneOf_ParameterType) -> Bool {
      ...
      case (.cursor(let l), .cursor(let r)): return l == r
      default: return false
      }
    }
  #endif
...
struct Google_Datastore_V1_QueryResultBatch {
  ...
  var skippedCursor: Data = SwiftProtobuf.Internal.emptyData
...
extension Google_Datastore_V1_EntityResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 4: try decoder.decodeSingularInt64Field(value: &self.version)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_Query: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 2: try decoder.decodeRepeatedMessageField(value: &self.projection)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.kind)
      case 4: try decoder.decodeSingularMessageField(value: &self._filter)
      case 5: try decoder.decodeRepeatedMessageField(value: &self.order)
      case 6: try decoder.decodeRepeatedMessageField(value: &self.distinctOn)
      case 7: try decoder.decodeSingularBytesField(value: &self.startCursor)
      case 8: try decoder.decodeSingularBytesField(value: &self.endCursor)
      case 10: try decoder.decodeSingularInt32Field(value: &self.offset)
      case 12: try decoder.decodeSingularMessageField(value: &self._limit)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_Projection: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._property)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_Filter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.filterType = .propertyFilter(v)}
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .compositeFilter(let v)?:
      try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
    case .propertyFilter(let v)?:
...
extension Google_Datastore_V1_GqlQuery: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.queryString)
      case 2: try decoder.decodeSingularBoolField(value: &self.allowLiterals)
      case 4: try decoder.decodeRepeatedMessageField(value: &self.positionalBindings)
      case 5: try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString,Google_Datastore_V1_GqlQueryParameter>.self, value: &self.namedBindings)
      default: break
      }
    }
  }
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.parameterType = .value(v)}
      case 3:
        if self.parameterType != nil {try decoder.handleConflictingOneOf()}
        var v: Data?
        try decoder.decodeSingularBytesField(value: &v)
        if let v = v {self.parameterType = .cursor(v)}
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_QueryResultBatch: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularEnumField(value: &self.entityResultType)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.entityResults)
      case 3: try decoder.decodeSingularBytesField(value: &self.skippedCursor)
      case 4: try decoder.decodeSingularBytesField(value: &self.endCursor)
      case 5: try decoder.decodeSingularEnumField(value: &self.moreResults)
      case 6: try decoder.decodeSingularInt32Field(value: &self.skippedResults)
      case 7: try decoder.decodeSingularInt64Field(value: &self.snapshotVersion)
      default: break
      }
    }
  }
