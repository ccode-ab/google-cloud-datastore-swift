...
struct Google_Datastore_V1_RunQueryRequest {
  ...
  enum OneOf_QueryType: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_RunQueryRequest.OneOf_QueryType, rhs: Google_Datastore_V1_RunQueryRequest.OneOf_QueryType) -> Bool {
      ...
      case (.gqlQuery(let l), .gqlQuery(let r)): return l == r
...
struct Google_Datastore_V1_RunQueryResponse {
  ...
  var batch: Google_Datastore_V1_QueryResultBatch {
    get {return _batch ?? Google_Datastore_V1_QueryResultBatch()}
    set {_batch = newValue}
  }
  ...
  var query: Google_Datastore_V1_Query {
    get {return _query ?? Google_Datastore_V1_Query()}
    set {_query = newValue}
  }
  ...
  fileprivate var _batch: Google_Datastore_V1_QueryResultBatch? = nil
  fileprivate var _query: Google_Datastore_V1_Query? = nil
}
...
struct Google_Datastore_V1_Mutation {
  ...
  enum OneOf_Operation: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_Mutation.OneOf_Operation, rhs: Google_Datastore_V1_Mutation.OneOf_Operation) -> Bool {
      switch (lhs, rhs) {
      case (.insert(let l), .insert(let r)): return l == r
      case (.update(let l), .update(let r)): return l == r
      case (.upsert(let l), .upsert(let r)): return l == r
  ...
  enum OneOf_ConflictDetectionStrategy: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_Mutation.OneOf_ConflictDetectionStrategy, rhs: Google_Datastore_V1_Mutation.OneOf_ConflictDetectionStrategy) -> Bool {
      switch (lhs, rhs) {
      case (.baseVersion(let l), .baseVersion(let r)): return l == r
      }
    }
  #endif
  }
...
struct Google_Datastore_V1_ReadOptions {
  ...
  enum OneOf_ConsistencyType: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_ReadOptions.OneOf_ConsistencyType, rhs: Google_Datastore_V1_ReadOptions.OneOf_ConsistencyType) -> Bool {
      switch (lhs, rhs) {
      case (.readConsistency(let l), .readConsistency(let r)): return l == r
      case (.transaction(let l), .transaction(let r)): return l == r
      default: return false
      }
    }
...
struct Google_Datastore_V1_TransactionOptions {
  ...
  enum OneOf_Mode: Equatable {
    ...
    static func ==(lhs: Google_Datastore_V1_TransactionOptions.OneOf_Mode, rhs: Google_Datastore_V1_TransactionOptions.OneOf_Mode) -> Bool {
      switch (lhs, rhs) {
      case (.readWrite(let l), .readWrite(let r)): return l == r
      case (.readOnly(let l), .readOnly(let r)): return l == r
      default: return false
      }
    }
  #endif
  ...
  struct ReadWrite {
    ...
    var previousTransaction: Data = SwiftProtobuf.Internal.emptyData
...
extension Google_Datastore_V1_LookupRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._readOptions)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.keys)
      case 8: try decoder.decodeSingularStringField(value: &self.projectID)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_LookupResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeRepeatedMessageField(value: &self.found)
      case 2: try decoder.decodeRepeatedMessageField(value: &self.missing)
      case 3: try decoder.decodeRepeatedMessageField(value: &self.deferred)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_RunQueryRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularMessageField(value: &self._readOptions)
      case 2: try decoder.decodeSingularMessageField(value: &self._partitionID)
      case 3:
        ...
        if let v = v {self.queryType = .query(v)}
      case 7:
        ...
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {self.queryType = .gqlQuery(v)}
      case 8: try decoder.decodeSingularStringField(value: &self.projectID)
      default: break
      }
    }
...
extension Google_Datastore_V1_BeginTransactionRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 8: try decoder.decodeSingularStringField(value: &self.projectID)
      case 10: try decoder.decodeSingularMessageField(value: &self._transactionOptions)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_CommitRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try decoder.decodeRepeatedMessageField(value: &self.mutations)
      case 8: try decoder.decodeSingularStringField(value: &self.projectID)
      default: break
      }
    }
...
extension Google_Datastore_V1_CommitResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 3: try decoder.decodeRepeatedMessageField(value: &self.mutationResults)
      case 4: try decoder.decodeSingularInt32Field(value: &self.indexUpdates)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_ReserveIdsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 1: try decoder.decodeRepeatedMessageField(value: &self.keys)
      case 8: try decoder.decodeSingularStringField(value: &self.projectID)
      case 9: try decoder.decodeSingularStringField(value: &self.databaseID)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_MutationResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 5: try decoder.decodeSingularBoolField(value: &self.conflictDetected)
      default: break
      }
    }
  }
...
extension Google_Datastore_V1_TransactionOptions.ReadWrite: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularBytesField(value: &self.previousTransaction)
      default: break
      }
    }
  }
